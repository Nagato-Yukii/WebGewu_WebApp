...
const defaultIceServer = {
  urls: ['turn:47.76.242.88:3478', 'stun:47.76.242.88:3478'],
  username: 'gewuedu',
  credential: 'gewuedu2026'
};
...
function setDefaultServer(serversSelect) {
  const option = document.createElement('option');
  option.value = JSON.stringify(defaultIceServer);
  option.text = defaultIceServer.urls.join(', ');
  option.ondblclick = selectServer;
